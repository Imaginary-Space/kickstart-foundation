...
-- Add analysis fields to photos table (one at a time)
ALTER TABLE public.photos ADD COLUMN ai_description TEXT;
ALTER TABLE public.photos ADD COLUMN ai_generated_tags TEXT[];
ALTER TABLE public.photos ADD COLUMN analysis_completed_at TIMESTAMP WITH TIME ZONE;
